            ...
            while ( true ) 
                   {
                          ...
                          try {
                              ...
                              {
                                  case "BCAST": afisareConferinta(mesajDescompus[1]);
                                                break;
                                  case "SERVER": afisareMesajServer(mesajDescompus[1]);
                                                 break;
                                  case "NUME":  nume = mesajDescompus[1];
                                                gui.modificareNume(nume);
                                                schimbare_nume_conversatii(nume);
                                                trimiteMesajServer("LIST");
                                                break;
                                  case "LISTA": int nrUtilizatori = Integer.parseInt(mesajDescompus[1]);
                                                afisareLista(nrUtilizatori);
                                                break;
                                  case "MSG":   mesajDescompus = fromServer.split(" ",3);
